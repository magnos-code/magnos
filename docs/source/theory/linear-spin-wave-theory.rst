...
We write as general a form of the Heisenberg Hamiltonian as possible,
...
where :math:`\mathbf{R}, \mathbf{R'}` are lattice vectors, :math:`b,b'` are indices of magnetic sites in the unit cell, and
