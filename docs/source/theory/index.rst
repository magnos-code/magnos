...
Magnos is a Python package for the quantitative simulation of magnons, i.e., quantized spin-wave excitations representing the coherent precession of spins around their equilibrium direction.
...
The magnon bandstructure can be derived using Linear Spin Wave Theory (LSWT) at the quantum level, or semiclassical spin dynamics - Magnos uses the former.
...
In the 'Linear Spin Wave Theory' section, we derive the general form of the Heisenberg Hamiltonian used by Magnos, and discuss all the steps necessary to diagonalize it and obtain the magnon bandstructure.
